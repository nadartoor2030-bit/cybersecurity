...
.matrix {
    ...
    animation: gridMove 8s linear infinite; /* Faster grid speed for loader context */
}
...
/* ==========================================================================
   3. APP CANVAS & HOLOGRAPHIC BACKGROUND
   ========================================================================== */
.background {
    position: fixed;
    top: 0;
...
.grid {
    ...
    background-image:
        ...
        linear-gradient(90deg, rgba(0,255,255,.08) 1px, transparent 1px);
    background-size: 40px 40px;
    animation: gridMove 18s linear infinite; /* Slower ambient grid speed for dashboard background */
}
...
/* ==========================================================================
   4. DASHBOARD LAYOUT & CARD HOUSINGS
   ========================================================================== */
header {
    text-align: center;
...
/* ==========================================================================
   5. RESULTS, GRAPHICS & OUTPUT REPORTS
   ========================================================================== */
.scanner {
    height: 10px;
    background: #132845;
